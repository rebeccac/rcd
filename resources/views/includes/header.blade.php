...
$active_index = \App\Helper::addActive('index', $page);
$active_about = \App\Helper::addActive('about', $page);
$active_contact = \App\Helper::addActive('contact', $page);
$active_gallery = \App\Helper::addActive('gallery', $page);
